...
class ParentComponent extends Component {
    ...
    greetParent() { // greetParent() method is used to alert a message when the button is clicked
        alert(`Hello ${this.state.parentName} Your age is ${this.state.parentAge}`) // alert() method is used to display an alert box with a specified message and an OK button
    }
